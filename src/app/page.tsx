...
import { Container, Title, Text, Grid, Card, Button, Badge, Group, Loader } from '@mantine/core'
...
export default function Dashboard() {
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      // Fetch today's submissions count
      const today = new Date().toISOString().split('T')[0]
      const { count: submissionsCount } = await supabase
        .from('form_submissions')
        .select(`
          *,
          forms!inner(facility_id)
        `, { count: 'exact', head: true })
        .eq('forms.facility_id', userProfile.facility_id)
      ...
      setStats({
        ...
        submissionsToday: submissionsCount || 0,
  ...
  return (
    <ProtectedLayout>
      <Container size="xl">
            ...
            <>
              ...
              <Grid.Col span={{ base: 12, md: 6, lg: 4 }}>
                <Card shadow="sm" padding="lg" radius="md" withBorder>
                  ...
                  <Button variant="light" fullWidth mt="md" component={Link} href="/patients">
                    Manage Patients
                  </Button>
                </Card>
              </Grid.Col>
          ...
          <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              {stats.loading ? (
                ...
                <Text ta="center" size="xl" fw={700}>{stats.totalForms}</Text>
              )}
            </Card>
          </Grid.Col>
          <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              {stats.loading ? (
                ...
                <Text ta="center" size="xl" fw={700}>{stats.submissionsToday}</Text>
              )}
            </Card>
          </Grid.Col>
          <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              <Text ta="center" fw={500} c="dimmed">Total Patients</Text>
              {stats.loading ? (
                <Loader size="sm" mx="auto" mt="xs" />
              ) : (
                <Text ta="center" size="xl" fw={700}>{stats.totalPatients}</Text>
              )}
            </Card>
          </Grid.Col>
          <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              {stats.loading ? (
                ...
                <Text ta="center" size="xl" fw={700}>{stats.totalStaff}</Text>
              )}
            </Card>
          </Grid.Col>
        </Grid>
        ...
        {userProfile?.role === 'manager' && (
          <>
            <Title order={2} mt="xl" mb="md">Quick Actions</Title>
            <Grid>
                ...
                <Card shadow="sm" padding="md" radius="md" withBorder>
                  <Group justify="space-between">
                    <div>
                      ...
                      <Text size="sm" c="dimmed">Register a new patient</Text>
                    </div>
                ...
                <Card shadow="sm" padding="md" radius="md" withBorder>
                  <Group justify="space-between">
                    <div>
                      ...
                      <Text size="sm" c="dimmed">Build assessment form</Text>
                    </div>
                ...
                <Card shadow="sm" padding="md" radius="md" withBorder>
                  <Group justify="space-between">
                    <div>
                      ...
                      <Text size="sm" c="dimmed">Manage patient records</Text>
                    </div>
                    <Button size="sm" variant="light" component={Link} href="/patients">
                      View
                    </Button>
                  </Group>
                </Card>
